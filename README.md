...
|------|-------------|---------|----------|
| codelens | High performance code analysis tool written in Rust — stats, health scores, hotspots, and trends. | `brew install DropFan/tap/codelens` | [GitHub](https://github.com/DropFan/codelens) |
